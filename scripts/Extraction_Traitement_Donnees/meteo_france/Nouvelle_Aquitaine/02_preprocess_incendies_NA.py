...
def associer_stations():
    ...
    output_path = r"C:\Users\User\OneDrive - Ministere de l'Enseignement Superieur et de la Recherche Scientifique\projet_incendies\outputs\intermediaires\meteo_france\Nouvelle_Aquitaine\incendies_NA_avec_station.csv"
